...
date: 9th July, 2016 (SappoRo.R \#6)
output:
...
- Graphviz: GraphvizはDOTと呼ばれるグラフ描画言語からできており、その言語を処理する様々なツールを含んでいます。DOTは高度にカスタマイズ可能で、ラインの色、矢印の形、ノードの形など、あらゆるレイアウトを制御することができます。
...
grViz("
      digraph boxes_and_circles {
      graph [overlap = true, fontsize = 10, layout = neato, overlap = true]
      node [shape = box, fontname = Helvetica]
        出張 [pos='-4,3!']
        二日酔い [pos='0,-2!']
      node [shape = circle, fontname = Helvetica]
